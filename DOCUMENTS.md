...
```bash
    ...
    php artisan migrate --path=/database/migrations/2024_11_20_101455_create_cuentafinancieras_table.php
    php artisan migrate --path=/database/migrations/2024_11_20_103403_add_cuentafinanciera_id_to_evaporacions_table.php
```
